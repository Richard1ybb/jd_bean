...
async function downFile () {
  ...
  if ($.body) {
    ...
    url = 'https://fastly.jsdelivr.net/gh/NobyDa/Script@master/JD-DailyBonus/JD_DailyBonus.js';
  }
  try {
    const options = { }
    ...
    $.get(options, async (err, resp, data) => {
      try {
        if (err) {
          ...
          await $.http.get({url: `https://fastly.jsdelivr.net/gh/NobyDa/Script@master/JD-DailyBonus/JD_DailyBonus.js`, timeout: 10000}).then((resp) => {
